...
**Backend (Rust):**
- New module `core/src/services/snapshots.rs`
- Commands:
...
**Frontend:**
- Modify `app/lib/components/Outline.svelte` to add HTML5 drag-and-drop on each heading item
- On drop, compute:
...
**Backend (Rust):**
- New module `core/src/services/writing_stats.rs`
- Commands:
